...
for (let i = 0; i < data.length; i++) {
    let myTd1 = document.createElement('td')//колонка для firstName
    let myTd2 = document.createElement('td')//колонка для lastName
    let myTd3 = document.createElement('td')//колонка для about
    let myTd4 = document.createElement('td')//колонка для eyeColor
    let myTr = document.createElement('tr')
    myTd1.textContent = data[i].name.firstName
    myTd2.textContent = data[i].name.lastName
    myTd3.textContent = data[i].about
    myTd4.textContent = data[i].eyeColor
